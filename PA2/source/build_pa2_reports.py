...
def base_document(title: str) -> Document:
    ...
    for name, size, color, before, after in [
        ...
        ("Heading 2", 16, BLUE, 10, 5),
        ("Heading 3", 14, GREEN, 8, 4),
    ]:
        style = styles[name]
    ...
    # The deliverable contract requires every visible paragraph style to remain
    # at or above 14 pt. Normalize inherited Word styles as well so later edits
    # cannot accidentally introduce small body, caption, or table text.
    for style in styles:
        if style.type == 1 and (style.font.size is None or style.font.size.pt < 14):
            style.font.size = Pt(14)
