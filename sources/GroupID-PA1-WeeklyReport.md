...
| 14 | Sprint review, PDF export, zip packaging, final validation | Visual QA | All | 4 | QA complete | GroupID-PA1.zip | Four PDFs at zip top level |
...
| --- | --- | --- |
| Product research | GroupID-PA1-ProductResearch.pdf | Pass after regeneration and text scan |
| Potential solutions | GroupID-PA1-PotentialSolutions.pdf | Pass after drawback/solution mapping check |
| Peer review | GroupID-PA1-PeerReview.pdf | Pass after seven-minute script and feedback check |
| Weekly report | GroupID-PA1-WeeklyReport.pdf | Pass after process and workload check |
| Submission package | GroupID-PA1.zip | Pass when exactly four PDFs are at zip top level |
